...
namespace Registry.Test
{
    ...
    internal class TestVKCellRecord
    {
        ...
        public void ShouldFindKeyValueAndCheckProperties()
        {
            ...
            Check.That(val.ValueName).IsEqualTo("(Default)"); // TL: Changed to uppercase
        ...
        public void ShouldFindRegBigEndianDWordValues()
        {
            ...
            var val = key.Values.Single(t => t.ValueName == "(Default)"); // TL: Changed to uppercase
        ...
        public void ShouldFindRegExpandSzValues()
        {
            ...
            val = key.Values.Single(t => t.ValueName == "(Default)"); // TL: Changed to uppercase
        ...
        public void TestVKRecordQWordWithLengthOfZero()
        {
            ...
            var val = key.Values.Single(e => e.ValueName == "(Default)"); // TL: Changed to uppercase
            ...
            Check.That(val.VKRecord.ValueName).IsEqualTo("(Default)"); // TL: Changed to uppercase
            Check.That(val.VKRecord.DataType).IsEqualTo(VKCellRecord.DataTypeEnum.RegQword);
